...
#ifndef ADMANAGER_SWIFT_H
#define ADMANAGER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AdManager",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC9AdManager10AdsManager")
@interface AdsManager : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


@interface AdsManager (SWIFT_EXTENSION(AdManager)) <GADBannerViewDelegate>
@end

@protocol GADFullScreenPresentingAd;

@interface AdsManager (SWIFT_EXTENSION(AdManager)) <GADFullScreenContentDelegate>
...
@interface AdsManager (SWIFT_EXTENSION(AdManager)) <GADNativeAdDelegate, GADNativeAdLoaderDelegate, GADVideoControllerDelegate>
