...
SWIFT_CLASS("_TtC9AdManager9AdManager")
@interface AdManager : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


@interface AdManager (SWIFT_EXTENSION(AdManager)) <GADBannerViewDelegate>
@end

@protocol GADFullScreenPresentingAd;

@interface AdManager (SWIFT_EXTENSION(AdManager)) <GADFullScreenContentDelegate>
...
@interface AdManager (SWIFT_EXTENSION(AdManager)) <GADNativeAdDelegate, GADNativeAdLoaderDelegate, GADVideoControllerDelegate>
